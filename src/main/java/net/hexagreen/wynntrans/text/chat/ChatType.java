...
public enum ChatType {
    ...
    MANA_POTION(ManaPotion::new, ManaPotion::typeChecker),
    POTION_EFFECT_APPLIED(PotionEffectApplied::new, PotionEffectApplied::typeChecker),
    CRAFTING_EXP_GAIN(CraftingEXPGain::new, CraftingEXPGain::typeChecker),
    DIALOG_ITEM(ItemGiveAndTake::new, ItemGiveAndTake::typeChecker),
    DEATH_MESSAGE(DeathMessage::new, DeathMessage::typeChecker),
    ...
    GATHERING_TOOL_LEVEL_REQ(GatheringToolLevelRequirement::new, GatheringToolLevelRequirement::typeChecker),
